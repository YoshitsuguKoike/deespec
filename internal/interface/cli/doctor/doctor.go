	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if common.GetGlobalConfig() != nil {
				fmt.Println("AgentBin:", common.GetGlobalConfig().AgentBin())
				fmt.Println("SpecsSBI:", paths.SpecsSBI)
				fmt.Println("Timeout:", time.Duration(common.GetGlobalConfig().TimeoutSec())*time.Second)
			} else {
			...
			agentBin := "claude"
			if common.GetGlobalConfig() != nil {
				agentBin = common.GetGlobalConfig().AgentBin()
			}
...
func runDoctorJSON() error {
	...
	if common.GetGlobalConfig() != nil {
		result.ConfigSource = common.GetGlobalConfig().ConfigSource()
		result.SettingPath = common.GetGlobalConfig().SettingPath()
	}
